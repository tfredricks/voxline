...
final class ModeStore {
    ...
    static let shippedDefaults: [Mode] = [
        // Chat
        Mode(bundleID: "com.tinyspeck.slackmacgap",         displayName: "Slack",       prompt: chatPrompt,    model: nil, temperature: nil, category: .chat),
        Mode(bundleID: "Cisco-Systems.Spark",               displayName: "Webex",       prompt: chatPrompt,    model: nil, temperature: nil, category: .chat),
        Mode(bundleID: "us.zoom.xos",                       displayName: "Zoom",        prompt: chatPrompt,    model: nil, temperature: nil, category: .chat),
        Mode(bundleID: "com.microsoft.teams2",              displayName: "Teams",       prompt: chatPrompt,    model: nil, temperature: nil, category: .chat),
        Mode(bundleID: "com.microsoft.teams",               displayName: "Teams (Classic)", prompt: chatPrompt, model: nil, temperature: nil, category: .chat),
        Mode(bundleID: "com.apple.MobileSMS",               displayName: "Messages",    prompt: chatPrompt,    model: nil, temperature: nil, category: .chat),
        Mode(bundleID: "com.hnc.Discord",                   displayName: "Discord",     prompt: chatPrompt,    model: nil, temperature: nil, category: .chat),
        Mode(bundleID: "ru.keepcoder.Telegram",             displayName: "Telegram",    prompt: chatPrompt,    model: nil, temperature: nil, category: .chat),
        Mode(bundleID: "net.whatsapp.WhatsApp",             displayName: "WhatsApp",    prompt: chatPrompt,    model: nil, temperature: nil, category: .chat),
        Mode(bundleID: "org.whispersystems.signal-desktop", displayName: "Signal",      prompt: chatPrompt,    model: nil, temperature: nil, category: .chat),
        // Email
        Mode(bundleID: "com.apple.mail",                    displayName: "Mail",        prompt: emailPrompt,   model: nil, temperature: nil, category: .email),
        Mode(bundleID: "com.microsoft.Outlook",             displayName: "Outlook",     prompt: emailPrompt,   model: nil, temperature: nil, category: .email),
        Mode(bundleID: "com.readdle.smartemail-Mac",        displayName: "Spark",       prompt: emailPrompt,   model: nil, temperature: nil, category: .email),
        // Long-form writing
        Mode(bundleID: "com.microsoft.Word",                displayName: "Word",        prompt: writingPrompt, model: nil, temperature: nil, category: .writing),
        Mode(bundleID: "com.apple.iWork.Pages",             displayName: "Pages",       prompt: writingPrompt, model: nil, temperature: nil, category: .writing),
        Mode(bundleID: "com.apple.Notes",                   displayName: "Notes",       prompt: writingPrompt, model: nil, temperature: nil, category: .writing),
        Mode(bundleID: "notion.id",                         displayName: "Notion",      prompt: writingPrompt, model: nil, temperature: nil, category: .writing),
        Mode(bundleID: "md.obsidian",                       displayName: "Obsidian",    prompt: writingPrompt, model: nil, temperature: nil, category: .writing),
        // Office, non-prose
        Mode(bundleID: "com.microsoft.Excel",               displayName: "Excel",       prompt: defaultPrompt, model: nil, temperature: nil, category: .general),
        Mode(bundleID: "com.microsoft.Powerpoint",          displayName: "PowerPoint",  prompt: defaultPrompt, model: nil, temperature: nil, category: .general),
        Mode(bundleID: "com.apple.iWork.Keynote",           displayName: "Keynote",     prompt: defaultPrompt, model: nil, temperature: nil, category: .general),
        Mode(bundleID: "com.apple.iWork.Numbers",           displayName: "Numbers",     prompt: defaultPrompt, model: nil, temperature: nil, category: .general),
        // Code / terminal
        Mode(bundleID: "com.apple.Terminal",                displayName: "Terminal",    prompt: codePrompt,    model: nil, temperature: nil, category: .code),
        Mode(bundleID: "com.googlecode.iterm2",             displayName: "iTerm",       prompt: codePrompt,    model: nil, temperature: nil, category: .code),
        Mode(bundleID: "com.microsoft.VSCode",              displayName: "VS Code",     prompt: codePrompt,    model: nil, temperature: nil, category: .code),
        Mode(bundleID: "com.todesktop.230313mzl4w4u92",     displayName: "Cursor",      prompt: codePrompt,    model: nil, temperature: nil, category: .code),
        Mode(bundleID: "com.apple.dt.Xcode",                displayName: "Xcode",       prompt: codePrompt,    model: nil, temperature: nil, category: .code),
        // Wildcard fallback (must stay last)
        Mode(bundleID: Mode.wildcardBundleID,               displayName: "Default",     prompt: defaultPrompt, model: nil, temperature: nil, category: .general),
    ]
}
